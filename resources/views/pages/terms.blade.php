...
<head>
    ...
    <title>Terms of Service — Pharmacy Owner by P3</title>
...
<body class="antialiased bg-white">
    ...
    <main class="max-w-4xl mx-auto px-4 py-12">
        ...
        <div class="prose prose-gray max-w-none">
            ...
            <p class="text-gray-700 mb-4">By accessing or using Pharmacy Owner by P3, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.</p>

            <h2 class="text-xl font-semibold text-gray-900 mt-8 mb-4">2. Use License</h2>
            <p class="text-gray-700 mb-4">Permission is granted to temporarily access the materials on Pharmacy Owner by P3's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title.</p>
            ...
            <p class="text-gray-700 mb-4">Property listings and content uploaded by users remain the responsibility of the user. Pharmacy Owner by P3 does not verify the accuracy of listing information and is not liable for any inaccuracies.</p>
            ...
            <p class="text-gray-700 mb-4">Pharmacy Owner by P3 shall not be liable for any damages arising from the use or inability to use the materials on this website, even if we have been notified of the possibility of such damages.</p>
            ...
            <p class="text-gray-700 mb-4">If you have any questions about these Terms, please contact us at legal@pharmacyowner.co.uk.</p>
        </div>
    </main>
